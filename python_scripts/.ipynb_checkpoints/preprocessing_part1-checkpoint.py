...
from utils import save_to_file, compute_ones_percentage, flip_longitude_360_2_180, month_to_season
...
def import_data():
    ...
    ## Predictors        
    (z, sm, sst, rain) =  (
                xr.open_mfdataset(access_z_eraint_file).z.load().sel(level = dictionary['geopotential_level']),
